  ...
  playgroundMessages: [
    {
      id: 'p1',
      sender: 'assistant',
      text: 'Merhaba! Ben ConneXion-AI Assistant. Sektörel bilgi tabanım ve anlık veri entegrasyonumla donatıldım. Finansal veri analizi, hukuki belge inceleme veya sağlık raporu kategorizasyonu konularında beni test edebilirsiniz.',
      timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
    },
  ],
